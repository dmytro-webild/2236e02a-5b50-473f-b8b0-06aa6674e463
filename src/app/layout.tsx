...
export const metadata: Metadata = {
  title: "KYRO | Modern Web Design & Development",  description: "KYRO builds fast, professional websites for businesses. Clean design, modern technology, and affordable pricing. Get your website built in 3-5 days.",  keywords: "web design, website development, professional websites, web development company, modern web design, affordable web design, fast website builder",  metadataBase: new URL("https://kyro.com"),
  alternates: {
    canonical: "https://kyro.com"
  },
  openGraph: {
    title: "KYRO - Build Your Presence",    description: "Modern websites that help your business grow",    url: "https://kyro.com",    siteName: "KYRO",    type: "website",    images: [{
      url: "http://img.b2bpic.net/free-vector/professional-dashboard-user-panel_23-2148358961.jpg",      alt: "KYRO web design showcase"
    }]
  },
  twitter: {
    card: "summary_large_image",    title: "KYRO | Modern Web Design",    description: "Fast, professional websites built for business growth",    images: ["http://img.b2bpic.net/free-vector/professional-dashboard-user-panel_23-2148358961.jpg"]
  },
  robots: {
    index: true,
    follow: true
